...
export const Modal = ({ title, onClose, children }: Props): JSX.Element => {
	...
	return (
		<div
			...
			<div className="modal-scroll w-full min-w-0 max-h-[92vh] md:max-h-[90vh] md:max-w-4xl overflow-auto rounded-t-3xl md:rounded-3xl bg-(--color-bg-secondary) border border-(--color-border)">
