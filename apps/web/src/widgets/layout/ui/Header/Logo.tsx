...
export const Logo = (): JSX.Element => {
	return (
		<Link
			...
			<LogoDark className="shrink-0 max-[420px]:h-[48px] h-[40px] w-[45px] md:h-[65px] md:w-[50px]" />
			<div className="max-[420px]:hidden min-w-0 leading-[1.05] text-(--color-text-primary)">
