...
export const DonationsSections = (): JSX.Element => {
	return (
		<section className="py-24 px-4 md:px-12 xl:px-12 max-w-[1920px] mx-auto grid min-w-0 grid-cols-1 gap-8 sm:gap-10 min-[1400px]:grid-cols-12 min-[1400px]:items-start min-[1400px]:gap-8">
