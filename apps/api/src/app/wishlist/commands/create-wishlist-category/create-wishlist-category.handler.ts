...
import { CreateWishlistCategoryResponseDto, ReturnDto } from '@pif/contracts';
...
export class CreateWishlistCategoryHandler implements ICommandHandler<CreateWishlistCategoryCommand> {
	...
	async execute({
		dto
	}: CreateWishlistCategoryCommand): Promise<ReturnDto<typeof CreateWishlistCategoryResponseDto>> {
