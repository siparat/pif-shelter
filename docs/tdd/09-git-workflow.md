...
Использует commitlint.
Проверяет, соответствует ли сообщение формату type(scope): subject.
Если вы напишете "fixed bug", коммит не пройдет. Нужно: "fix(core): resolve null pointer exception".
